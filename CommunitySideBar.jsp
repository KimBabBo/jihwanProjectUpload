	...
	<head>
		...
		<script>
			$(document).ready(function() {
				...
				// WebSocket 연결 코드
				socket = new WebSocket("ws://localhost:9090/TeamProject/websocket");
		...
		<ul class="leftBar">
			<%if(regNo!=0){ %>
				<li id="postWrite">	<!-- 게시판 글쓰기 이동 -->
					<a href="Controller?command=postWrite">
			...
			<li class="allWrite">	<!-- 게시판 메인화면 이동 -->
				<a href="Controller?command=community">
			...
			<!-- 각 게시판 이동 -->
			<li>
				<a href="Controller?command=communityBoard&boardNo=1">&nbsp;
					<img src="Images/gameCon.png">
					<span class="boardMain" style="font-weight:450;"> 게임 게시판</span>
				</a>
				<br>
			</li>
			<li><a href="Controller?command=communityBoard&boardNo=3"> &emsp;┖&nbsp; <span class="boardMain" style="font-weight:300;">공략 게시판 </span></a><br></li>
			<li><a href="Controller?command=communityBoard&boardNo=7"> &emsp;┖&nbsp; <span class="boardMain" style="font-weight:300;">자랑 게시판 </span></a><br></li>
			<li><a href="Controller?command=communityBoard&boardNo=6"> &emsp;┖&nbsp; <span class="boardMain" style="font-weight:300;">질문 게시판 </span></a><br></li>
			<li>
				<a href="Controller?command=communityBoard&boardNo=2">&nbsp;
			...
			<li>
				<a href="Controller?command=communityBoard&boardNo=4">&nbsp;
					<img src="Images/monitor.png">
					<span class="boardMain" style="font-weight:450;"> PC방 게시판</span>
				</a> 
				<br>
			</li>
			<li><a href="Controller?command=communityBoard&boardNo=5"> &emsp;┖&nbsp; <span class="boardMain" style="font-weight:300;">PC방 문의 게시판 </span></a><br></li>
			<li id="p2pChat">
				<div id="chatBtn">
