...
public class PostDAO {
	...
	private String dbid = "projectDB";
	private String dbpw = "pass1234";
	...
	public ArrayList<PostDTO> showPost(int postNo) {
		...
		String sql = "SELECT p.title,b.board_title,m.nickname,p.upload_date, p.view_cnt, p.like_cnt, p.content"
				+ " FROM post p, member m, board b WHERE p.reg_no=m.reg_no AND b.board_no=p.board_no AND post_no=?";
		try (PreparedStatement pstmt = conn.prepareStatement(sql)) {
